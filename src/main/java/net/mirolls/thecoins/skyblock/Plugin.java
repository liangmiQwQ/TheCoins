...
public class Plugin {
  ...
  private final ArrayList<ItemStack> menuItemStack; // menu上的itemStack，就是图标，通常使用factory构造
  ...
  public Plugin(ArrayList<ItemStack> menuItemStack, ArrayList<PluginButtonLocation> itemStackLocations) {
  ...
  public ArrayList<ItemStack> getMenuItemStack() {
